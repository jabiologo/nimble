...
<br/><br/>
```{r ch1, cache = T, message=FALSE, fig.height = 3, fig.width = 8, fig.align = "center"}
library(plgp)
library(mvtnorm)
library(raster)
library(spBayes)
...
psi <- exp(-1.2 + 2.9*temper)/(1+exp(-1.2 + 2.9*temper))
distr <- psi
...
```{r ch2, cache = T, message=FALSE, fig.height = 3, fig.width = 8, fig.align = "center"}
...
```{r ch3, cache = T, message=FALSE, fig.height = 7.5, fig.width = 7, fig.align = "center"}
...
outEq <- PGOcc(occ.formula = ~ temper, 
               det.formula = ~ 1, 
               data = data.list, 
               inits = inits.list, 
               n.samples = 5000,  
...
```{r ch4, cache = T, message=FALSE, fig.height = 7.5, fig.width = 7, fig.align = "center"}
...
```{r ch5, cache = T, message=FALSE, fig.height = 7.5, fig.width = 7, fig.align = "center"}



outNonEq <- spPGOcc(occ.formula = ~ temper, 
               det.formula = ~ 1, 
               data = data.list, 
               inits = inits.list, 
               n.batch = n.batch, 
